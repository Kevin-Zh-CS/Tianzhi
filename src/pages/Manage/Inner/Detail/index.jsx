...
import { Alert, Icons, Button, Table, IconBase, Tabs, Modal, Input, message } from 'quanta-design';
          ...
          showAlert ? (
            <>
              <Alert
                ...
                message={
                  <>
                    <div style={{ fontSize: 16, color: '#121212' }}>资源库信息编辑规则</div>
                    <div style={{ whiteSpace: 'pre', color: '#595959', marginTop: 8 }}>
      ...
      <div className={styles.contentWrap}>
        <Tabs activeKey={activeKey} onChange={setActiveKey} tabBarStyle={{ padding: '0px 20px 0' }}>
          <TabPane tab="基本信息" key="1">
            <ResourceInfo namespace={namespace} auth={auth} />
          </TabPane>
