...
import ConfigItemDetail from './componments/ConfigItemDetail';
...
function QflSponsorDetail(props) {
  ...
  return (
    <NewPage title="任务详情" onBack={() => router.goBack()} noContentLayout>
      <Spin spinning={loading}>
        ...
        dataInfo.status === STEP_STATUS.loading ? null : (
...
export default QflSponsorDetail;
